...
while True:
    ...
    try:
        ...
        if choice == 'a':
            ...
            if(len(data_text_file)==0):
                print("No questions saved")
            else:
                print("Current Question:")
                for i in range(0,len(data_text_file)):
                    print('\t',i+1,")",data_text_file[i]['question'])    
            ...
            for i in range(len(data_text_file)):
                if search_term in data_text_file[i]['question']:
            ...
            try:
                req_data = data_text_file[view_index-1]
                print("Question:")
            ...
            try:
                ...
                if(del_index+1>len(data_text_file)):
                    print("Invalid index number")
                else:
                    del_question = data_text_file.pop(del_index)
